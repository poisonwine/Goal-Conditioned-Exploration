...
class RealNVP(nn.Module):
    def __init__(self, prior=None, input_channel=2, lr=1e-3, num_layer_pairs=3, dev='cpu'):
        super().__init__()
...
class CouplingLayer(nn.Module):
    def __init__(self, mask_type, input_channel, dev = 'cpu'):
        super().__init__()
