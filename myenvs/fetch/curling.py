...
# MODEL_XML_PATH = os.path.join('curling.xml')
MODEL_XML_PATH = os.path.join(os.path.dirname(__file__), 'assets', 'curling.xml')
...
class FetchCurlingEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        self.adapt_dict["probs"] = [1, 0, 0, 0, 0, 0]
