...
#MODEL_XML_PATH = os.path.join('myUR5', 'find.xml')
...
class myUR5FindEnv(robot_env.RobotEnv, EzPickle):
    ...
    def __init__(self, reward_type='sparse'):
        ...
        n_substeps = 20
        model_path = os.path.join('myUR5', 'find.xml')
        initial_qpos = {
        ...
        super(myUR5FindEnv, self).__init__(
...
#        gripper_vel = robot_qvel[-2:] * dt  # change to a scalar if the gripper is made symmetric
    ...
    def render(self, mode='human', width=500, height=500):
        # TODO: update myUR5<>Env
        return super(myUR5FindEnv, self).render(mode, width, height)
